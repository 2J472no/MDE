_base_ = [
    '../_base_/models/ehs.py', '../_base_/datasets/kitti.py',
...
model = dict(
    ...
    decode_head=dict(
        ...
        # in_channels=[32, 64, 128, 512, 2048],
        # in_channels=[32, 64, 128, 512, 2048],
        # in_channels=[8, 16, 32, 1024, 2048],
        # in_channels=[16, 32, 64, 1024, 2048],
        # in_channels=[8, 32, 128, 512, 2048],
        # in_channels=[32, 128, 128, 512, 2048],
        # channels=1,
        # channels=32,
        in_channels=[8, 16, 32, 1024, 2048],
