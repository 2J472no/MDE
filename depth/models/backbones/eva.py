...
def EVA(pretrained=True, patch_size=(12, 32),
        # img_size=(352, 1216),
        **kwargs) -> Eva:
    # ref_feat_shape = (img_size[0]//patch_size[0], img_size[1]//patch_size[1])
    # ref_feat_shape = (int(np.ceil(img_size[0]/patch_size[0])), int(np.ceil(img_size[1]/patch_size[1])))
    model_args = dict(
        # img_size=img_size,
        # img_size=448,
        embed_dim=1024,
